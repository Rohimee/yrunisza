        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
          <div class="menu_section">
            ...
            <ul class="nav side-menu">
              ...
              <?php }  ?>
              <!--<li><a><i class="fa fa-table"></i> จัดการข้อมูลอาจารย์ <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                  <li><a href="#">ยืนยันตัวตน (อาจารย์)</a></li>
                  <li><a href="#">รายชื่ออาจารย์ที่เข้าขอใช้งานระบบ</a></li>
                </ul>
              </li>-->
            </ul>
          </div>
