                ...
                <table class="table table-striped table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="#" class="btn btn-info"><i class="fa fa-edit" title="แก้ไข"></i></a><a href="delete.php?action=transfer&transfer_id=<?=$row['transfer_id']?>" class="btn btn-danger" onclick="return confirm('ยืนยันการลบข้อมูลนี้ ?');"><i class="fa fa-trash" title="ลบ"></i></a>
                      </td>
                    </tr>
